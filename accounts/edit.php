      ...
      <img src="../<?php echo $rows['post_image'];?>" width="150px">		
		<div class="form-group">
		  ...
		  <div class="form-group">
			  ...
			  <input type="text" id="title" name="post_title" value="<?php echo $rows['post_title'];?>" class="form-control" required>
		 </div>
			  ...
			  <select class="form-control" id="post_category" name="post_category" required>
			    <option value="">Select Category</option>
				   ...
				   while($results=mysqli_fetch_assoc($run_query)){
					   ...
					   echo'<option value="'.$results['cat_name'].'">'.ucfirst($results['cat_name']).'</option>';
				   }
		  ...
		  <div class="form-group">
		      ...
		      <textarea class="form-control" name="post_description" required><?php echo $rows['post_description'];?></textarea>
		 </div>
