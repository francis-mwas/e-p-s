...
<div class="col-md-12">
<h2 class="title" align="center" style="color:#fff;">Exams Processing System | Student Results Form</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<h3 style="text-align: center;text-decoration:underline;margin: 5px;">LORETO GIRLS SECONDAY SCHOOL, KIAMBU</h3>
<?php
// code Student Data
...
$qery = "SELECT students.fullname,students.adm_no,students.date_added,students.s_id,class.class_abbr,class.streams from students join class on class.class_id=students.class_id where students.adm_no=:adm and class.class_id=students.class_id";
...
<td><b><a href="download-result.php">Student's position</a> </b></td>
</tr>

 <?php } else { ?>     
<div class="alert alert-warning left-icon-alert" role="alert">
<strong>Notice!</strong> This student results have not yet been added.
 <?php }
?>
</div>
 <?php 
...
<div class="col-sm-6">
<a href="index.php" class="bg-success" style="font-size: 18px;">Go to home page</a>
</div>
 </div>
</div>
</div>
