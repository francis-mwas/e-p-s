...
echo "Your username is:" .$_SESSION['username'];	
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {?>
  <p> <?php echo htmlentities($row['sub_name']);?> --> subject id  <?php echo htmlentities($row['sub_id']);?><input type="text"  name="marks[]" value="" class="form-control" required="" placeholder="Enter marks out of 100" autocomplete="off"></p>
  <p><?php  ?></p>
