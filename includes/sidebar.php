<aside class="col-lg-4">
		<form class="panel-group form-horizontal" role="form" action="./search.php">
			   ...
			   <div class="panel-heading">Login Area.</div>			       
				   <div class="panel-body">
					   <div class="form-group">
						   ...
						   <div class="col-sm-7">
						       <input type="text" id="username" placeholder="username i.e email" name="username" class="form-control">
						   </div>
					   </div>
					   ...
					   <div class="form-group">
						   ...
						   <div class="col-sm-7">
						       <input type="password" id="pass" placeholder="password" name="password" class="form-control">
						   </div>
					   </div>
					    ...
					    <div class="form-group">
						   ...
						   <div class="col-sm-12">
							   ...
							   <button class="btn  btn-primary" name="login">Send Message</button>
						   </div>
					   </div>
			...
			//include_once("db/conn.php");
			  $sql_query="SELECT * FROM posts WHERE status='published' ORDER BY post_id DESC LIMIT 6";
