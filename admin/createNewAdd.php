...
<div class="col-lg-10">
    ...
    <div class="row">
           <?php validateTeachersCreation(); ?>
         
            <div class="well well-sm">
                <?php display_message();?>
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <legend class="text-center header">Create new account for a teacher.</legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="username" name="username" type="email" placeholder="Username" class="form-control" />
                            </div>
                        </div> 
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="glyphicon glyphicon-map-marker bigicon"></i></span>
                            <div class="col-md-8">
                                <label for="tsc no"><span>Tsc number</span></label>
                                <input type="text" id="tsc_no" name="tsc_no"  placeholder="tsc no" class="form-control" />
                            </div>
                        </div>                        
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="p_photo" type="file" name="profile_photo"  placeholder="Profile photo" class="form-control">
                            </div>
                        </div>
