...
$pdf->Cell($width_cell[1],10,'Subject',1,0,true); // Second header column
$pdf->Cell($width_cell[2],10,'%',1,0,true); // Third header column 
$pdf->Cell($width_cell[3],10,'grade',1,0,true); // Fourth header column
...
$pdf->Cell($width_cell[1],10,$row['sub_name'],1,0,$fill);
$pdf->Cell($width_cell[2],10,$row['marks'],1,0,$fill);
$pdf->Cell($width_cell[3],10,$row['marks'],1,0,$fill);
$pdf->Cell($width_cell[4],10,$row['points'],1,1,$fill);
