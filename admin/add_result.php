...
$mar=$mark[$i];
$sid=$sid1[$i];
$sql="INSERT INTO  tblresult(s_id,class_id,sub_id,marks,PostingDate,posted_by,typeId,remarks,term_id) VALUES(:studentid,:class,:sid,:marks,:date_added,:posted_by,:typeId,:remarks,:term_id)";
$query = $dbh->prepare($sql);
$query->bindParam(':studentid',$studentid,PDO::PARAM_STR);
$query->bindParam(':class',$class,PDO::PARAM_STR);
$query->bindParam(':sid',$sid,PDO::PARAM_STR);
//$query->bindParam(':sub_id',$sub_d,PDO::PARAM_STR);
...
<label for="default" class="col-sm-2 control-label">Teacher's Name</label>
 <div class="col-sm-8">
 <input type="text" name="posted_by" value="<?php echo $_SESSION['username'];?>" tabindex="2" class="form-control">
</div>
</div> 
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Term</label>
 ...
 <div class="col-sm-8">
 <select name="term_id" class="form-control clid" id="classid" required="required">
...
{   ?>
<option value="<?php echo htmlentities($result->term_id); ?>"><?php echo htmlentities($result->name);?></option>
<?php }} ?>
 </select>
</div>
</div>
...
<label for="default" class="col-sm-2 control-label">Exam type</label>
 ...
 <div class="col-sm-8">
 <select name="typeId" class="form-control clid" id="classid" required="required">
<option value="">Select Exam type</option>
<?php $sql = "SELECT * from exams";
$query = $dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
if($query->rowCount() > 0)
...
foreach($results as $result)
{   ?>
<option value="<?php echo htmlentities($result->exam_id); ?>"><?php echo htmlentities($result->type); ?></option>
<?php }} ?>
 </select>
</div>
</div>
...
<div class="form-group">
<label for="date" class="col-sm-2 control-label ">Remarks.</label>
<div class="col-sm-8">
   <textarea class="form-control" id="remarks" name="remarks" placeholder="Teachers remarks." rows="7">
   </textarea>
</div>
</div>
