           ...
           ?>
            ...
            <div class="well well-sm">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <legend class="text-center header">Add a new term</legend>
                        ...
                        <div class="form-group">
                           <span class="col-md-1 col-md-offset-2 text-center"><i class="glyphicon glyphicon-hand-right bigicon"></i></span>
                            <div class="col-md-8">
                                ...
                                <input id="term_name" name="name" type="text" placeholder="Term name" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="term_year" name="year" type="text" placeholder="Term year" class="form-control" required>
                            </div>
                        </div>                       
                        <div class="form-group">
