...
if(isset($_GET['u_id'])){
    ...
    $sql_query="UPDATE users SET active='0' WHERE user_id='$u_id'";
    $run_query=query($sql_query);
    if($run_query){
         set_messages("<p class='alert alert-success alert-dismissible' role='alert'>User deactivated successfully.</p>");
